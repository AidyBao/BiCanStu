...
+ (BOOL)isPasswordValid:(NSString *)password{
    return [ZXStringUtils isString:password matchingRegularString:PASSWORD_REG];
}

+ (BOOL)isEmailValid:(NSString *)email{
    return [ZXStringUtils isString:email matchingRegularString:EMAIL_REG];
}

+ (BOOL)isMobileValid:(NSString *)mobile{
    return [ZXStringUtils isString:mobile matchingRegularString:MOBILE_REG];
}
