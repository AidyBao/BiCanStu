...
//MARK: -- 正文
/**标题1 字体大小 默认 6:17号*/
extern CGFloat zx_title1FontSize();
/**标题2 字体大小 默认 6:15号*/
extern CGFloat zx_title2FontSize();
/*!正文 字体大小 默认 6:14号*/
extern CGFloat zx_bodyFontSize();

//MARK: -- 导航栏
/**导航栏 Title文字大小 默认 6:21号*/
extern CGFloat zx_navBarTitleFontSize();
/**导航栏 按钮文字大小 默认 6:18号*/
extern CGFloat zx_navBarButtonTitleFontSize();

//MARK: -- 标签栏
/**标签栏 按钮文字大小 默认 系统字号*/
extern CGFloat zx_tabBarItemTitleFontSize();

//MARK: -- 通用按钮

/**字体名称 字号*/
@interface UIFont (ZXFont)

//MARK: -- 通用按钮字号
/**通用按钮 字号*/
extern CGFloat zx_buttonTitleFontSize();
