...
@interface ZXWebEngine ()<UIWebViewDelegate,UIScrollViewDelegate>
{
    CGFloat offsetY;
    BOOL bShow;
    BOOL trackingScroll;
...
- (void)viewDidLoad {
    ...
    [self.btnBack setImage:[NSBundle zx_navBackImage] forState:UIControlStateNormal];
    ...
    [self.webView setBackgroundColor:ZXWHITE_COLOR];
...
//    [self.webView setScalesPageToFit:true];
    ...
    trackingScroll = true;
    isAnimating = false;
    [self.progressBack setBackgroundColor:[UIColor zx_navbarColor]];
}
...
//        [_currentProgress setBackgroundColor:ZXRGB_COLOR(53, 167, 144)];
...
- (void)setProgress:(CGFloat)value{
    ...
    CGFloat width = ZX_BOUNDS_WIDTH * value;
