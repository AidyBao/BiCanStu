...
#import "ZXItemSelectTableCell.h"
...
- (void)viewDidLoad {
    ...
    [_tblCheckList registerNib:[UINib nibWithNibName:@"ZXItemSelectTableCell" bundle:nil] forCellReuseIdentifier:@"ZXItemSelectTableCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ZXItemSelectTableCell * cell = [tableView dequeueReusableCellWithIdentifier:@"ZXItemSelectTableCell" forIndexPath:indexPath];
